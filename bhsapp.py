...
def details():
    ...
    components.html('<iframe src="https://github.com/Brendanlearnings/bhs_app/blob/5383d285b9de40f3b5d8ce85d0b86b51223d1f9b/HJS%2010%20Jaar%20Reunie%20Final.pdf" width="700" height="1000" type="application/pdf"</iframe>')
