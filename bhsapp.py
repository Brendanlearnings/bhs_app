...
def details():
    ...
    with open('https://github.com/Brendanlearnings/bhs_app/blob/5383d285b9de40f3b5d8ce85d0b86b51223d1f9b/HJS%2010%20Jaar%20Reunie%20Final.pdf','rb') as file:
        pdf = base64.b64encode(file.read()).decode('utf-8')
    display_pdf = f'<iframe src="data:application/pdf;base64,{pdf}" width="700" height="1000" type="application/pdf"></iframe>'
