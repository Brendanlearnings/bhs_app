...
def details():
    ...
    #     pdf = base64.b64encode(file.read()).decode('utf-8')
    display_pdf = f'<iframe src="https://github.com/Brendanlearnings/bhs_app/blob/a00061ed504923e7ab5c5f055b804ad72ae677f6/HJS_10_Jaar_Reunie_Final.pdf" width="700" height="1000" type="application/pdf"></iframe>'
